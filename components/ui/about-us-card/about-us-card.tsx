...
export default function AboutUsCard() {
	...
	return (
		<div className="w-full p-6 py-12 bg-white sm:border sm:border-gray-200 rounded-xl shadow text-center sm:mx-2">
			...
			<div className="flex justify-between text-center my-16 mx-auto sm:w-3/6">
				{shuffledTeam.length > 0 ? shuffledTeam.map((member) => (
					<div>
			...
			<div className="my-5 mx-auto sm:w-3/6 flex justify-between">
				<div>
				...
				<div>
					...
					<h2 className="text-lg font-semibold">Independent Contracts</h2>
				</div>
				<div>
