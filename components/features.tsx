														...
														>
															{project.gifs.map((gif, index) => (
																<SwiperSlide key={index} className="shadow-none">
																	<div className="flex justify-center items-center h-full background-soft-gray">
																		<span className="relative p-3 h-full flex items-center">
																			...
																			<Image src={gif} className="h-auto w-auto max-h-full max-w-full" alt="Features bg" />
																		</span>
																	</div>
																</SwiperSlide>
															))}
															...
															<SwiperSlide>
																<div className="flex justify-center border border-gray-200 rounded-lg items-center h-full w-full background-soft-gray">
																	...
																	<div className="flex flex-column justify-center w-full absolute  font-semibold bottom-2 text-xs">
